         ...
         <nav class="navbar bg-light navbar-light">
             ...
             <div class="d-flex align-items-center ms-4 mb-4">
                 <div class="position-relative">
                     <img class="rounded-circle" src="{{ (Auth::user()->profile_picture ) ? asset('storage/profile_pictures/' . Auth::user()->profile_picture ) : asset('img/dummy_user.png') }}" alt="" style="width: 40px; height: 40px;">
                     <div
