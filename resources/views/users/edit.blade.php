...
<div class="content_area">
    ...
    <div class="card ">
        ...
        <form method="Post" action="{{ route('users.update', $user->id) }}" class="py-3 needs-validation" novalidate id="users_form">
            @csrf
            @method('PUT')
            <div class="row">
            ...
            <div class="row">
                <div class="form-group  col-6 py-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" required name="password" id="name"
